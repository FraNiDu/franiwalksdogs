...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__6752){
var map__6753 = p__6752;
var map__6753__$1 = (((((!((map__6753 == null))))?(((((map__6753.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6753.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6753):map__6753);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6753__$1,cljs.core.cst$kw$handler);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4047__auto__ = p1__6755_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__6756){
var map__6757 = p__6756;
var map__6757__$1 = (((((!((map__6757 == null))))?(((((map__6757.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6757.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6757):map__6757);
var request = map__6757__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6757__$1,cljs.core.cst$kw$interceptors);
...
var api = (function (){var or__4047__auto__ = cljs.core.cst$kw$api.cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
