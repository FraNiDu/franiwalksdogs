...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__6766 = cljs.core.second(format);
var G__6767 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__6766,G__6767) : ajax.easy.keyword_response_format_element.call(null,G__6766,G__6767));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__6770_SHARP_){
return ajax.easy.keyword_response_format_element(p1__6770_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__6771){
var map__6772 = p__6771;
var map__6772__$1 = (((((!((map__6772 == null))))?(((((map__6772.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6772.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6772):map__6772);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6772__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6772__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6772__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__6772,map__6772__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__6774){
var vec__6775 = p__6774;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6775,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6775,(1),null);
var fexpr__6778_6779 = (cljs.core.truth_(ok)?h:e);
(fexpr__6778_6779.cljs$core$IFn$_invoke$arity$1 ? fexpr__6778_6779.cljs$core$IFn$_invoke$arity$1(result) : fexpr__6778_6779.call(null,result));
...
;})(h,e,map__6772,map__6772__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__6780){
var map__6781 = p__6780;
var map__6781__$1 = (((((!((map__6781 == null))))?(((((map__6781.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6781.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6781):map__6781);
var opts = map__6781__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6781__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6781__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6781__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6781__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6781__$1,cljs.core.cst$kw$body);
