...
var G__5868 = o;
(G__5868[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__5869__delegate = function (args){
...
while (G__5870__i < G__5870__a.length) {G__5870__a[G__5870__i] = arguments[G__5870__i + 0]; ++G__5870__i;}
  args = new cljs.core.IndexedSeq(G__5870__a,0,null);
} 
...
var G__5872 = o;
(G__5872[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__5877 = props;
var G__5877__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5877,cljs.core.cst$kw$id,id):G__5877);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5877__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__5878){
var map__5879 = p__5878;
var map__5879__$1 = (((((!((map__5879 == null))))?(((((map__5879.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5879.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5879):map__5879);
var props = map__5879__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5879__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__5879,map__5879__$1,props,class$){
return (function (c){
...
});})(map__5879,map__5879__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__5881){
var map__5882 = p__5881;
var map__5882__$1 = (((((!((map__5882 == null))))?(((((map__5882.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5882.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5882):map__5882);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5882__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__5882,map__5882__$1,on_write){
return (function (){
...
});})(node_value,map__5882,map__5882__$1,on_write))
);
} else {
...
var G__5885 = jsprops;
(G__5885["defaultValue"] = value);

(G__5885["onChange"] = ((function (G__5885,v,value,on_change){
return (function (p1__5884_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__5884_SHARP_);
});})(G__5885,v,value,on_change))
);
...
var vec__5888 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5888,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5888,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5888,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___5892 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___5892 == null)){
} else {
var key_5893 = temp__5461__auto___5892;
(jsprops["key"] = key_5893);
}
...
var temp__5461__auto___5894 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___5894 == null)){
} else {
var key_5895 = temp__5461__auto___5894;
reagent.impl.template.oset(jsprops,"key",key_5895);
}
...
var G__5896 = reagent.impl.template.__GT_NativeWrapper();
(G__5896["name"] = c);
...
var G__5897 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__5897) : reagent.impl.template.as_element.call(null,G__5897));
} else {
...
var len__4641__auto___5902 = arguments.length;
var i__4642__auto___5903 = (0);
while(true){
if((i__4642__auto___5903 < len__4641__auto___5902)){
args__4647__auto__.push((arguments[i__4642__auto___5903]));

var G__5904 = (i__4642__auto___5903 + (1));
i__4642__auto___5903 = G__5904;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq5900){
var G__5901 = cljs.core.first(seq5900);
var seq5900__$1 = cljs.core.next(seq5900);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5901,seq5900__$1);
});
...
break;
default:
var G__5907 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__5907;
continue;
...
var n__4518__auto___5909 = a.length;
var i_5910 = (0);
while(true){
if((i_5910 < n__4518__auto___5909)){
(a[i_5910] = reagent.impl.template.as_element((a[i_5910])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4518__auto___5912 = a.length;
var i_5913 = (0);
while(true){
if((i_5913 < n__4518__auto___5912)){
var val_5914 = (a[i_5913]);
if(((cljs.core.vector_QMARK_(val_5914)) && ((reagent.impl.template.key_from_vec(val_5914) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_5913] = reagent.impl.template.as_element(val_5914));

var G__5915 = (i_5913 + (1));
i_5913 = G__5915;
continue;
} else {
}
...
var ctx = ({});
var vec__5916 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5916,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5916,(1),null);
...
var G__5919 = (cljs.core.count(argv) - first_child);
switch (G__5919) {
case (0):
...
var G__5920 = comp;
var G__5921 = jsprops;
var G__5922 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__5920,G__5921,G__5922) : reagent.impl.template.global$module$react.createElement.call(null,G__5920,G__5921,G__5922));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__5919){
